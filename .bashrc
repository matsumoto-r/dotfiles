...
export PS1="\[\033[01;32m\][\u\[\033[01;34m\]@`hostname`:\[\033[01;32m\]\w]$ \[\033[00m\]"
export SSH_AUTH_SOCK=`ls -l /tmp/ssh-*/agent.* | grep $USER | awk '{print $9}' | sed -e "s/=$//" | tail -n 1`
export SSH_AGENT_PID=`ps -eo user:20,pid,args | grep ssh-agent | grep $USER | grep -v grep | awk '{print $2}' | tail -n 1`
